...
def init_periodic_table():
	...
	table = {}
	table["H"] = Element("Hydrogen", "H", 1.00794)
	...
	table["Al"] = Element("Aluminum", "Al", 26.9815386)
	...
	table["Ca"] = Element("Calcium", "Ca", 40.078)
	table["Sc"] = Element("Scandium", "Sc", 44.955912)
	table["Ti"] = Element("Titanium", "Ti", 47.867)
	...
	table["Pr"] = Element("Praseodymium", "Pr", 140.90765)
	...
	table["Pa"] = Element("Protactinium", "Pa", 231.03588)
...
def parse(formula):
	...
	example, this function will convert
	"H2O" to {"H":2, "O":1} and
...
def molar_mass(elem_dict):
	"""Compute and return the total atomic mass of all
